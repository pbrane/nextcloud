package org.beacon.nextcloud.plugin;
...
import org.beacon.nextcloud.plugin.model.Alert;
...
public class AlarmForwarder implements AlarmLifecycleListener {
    ...
    private static final String UEI_PREFIX = "uei.opennms.org/nextcloud-pluginPlugin";
