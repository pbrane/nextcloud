package org.beacon.nextcloud.plugin.shell;
...
import org.beacon.nextcloud.plugin.TopologyForwarder;
import org.beacon.nextcloud.plugin.model.Topology;

@Command(scope = "opennms-nextcloud-plugin", name = "push-topology", description = "Push the topology")
@Service
